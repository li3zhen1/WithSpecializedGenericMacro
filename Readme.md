...
A peer macro expanding generic **struct or class** to a specialized type, so as to help code optimization. To some degree, this macro makes generics in Swift work like C++ templates.
